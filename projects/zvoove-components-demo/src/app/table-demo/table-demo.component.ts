...
import { ZvTableComponent, ZvTableDataSource, IZvTableActionRouterLink, ZvTableActionScope } from '@zvoove/components/table';
...
export class TableDemoComponent {
  ...
  public dataSource = new ZvTableDataSource<ISampleData>({
    mode: 'server',
    loadTrigger$: of(null),
    loadDataFn: (filter) =>
